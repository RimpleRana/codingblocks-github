...
<div class="container d-flex align-items-center">
    <a href="index.html" class="logo mr-auto"><img src="https://cb3img.s3.ap-south-1.amazonaws.com/img/cblogo.webp"
            alt="Coding Blocks" class="img-fluid"></a>
    ...
    <a href="https://www.codingblocks.com/login.html" class="get-started-btn scrollto">Login / Signup</a>
...
<div class="btmheadnav">
    <div class="container d-flex position-relative ">
        ...
        <a href="index.html" class="position-absolute logo btmlogo mr-auto" style="left: -15px;" ><img
                                                ...
                                                <div class="col-lg-4 left">
                                                    <ul id="tabMMLnk" class="mmtabgroup">
                                                        ...
                                                        <li><a href="#tabMM7" class="lstmmtab"><img
                                                                    src="https://cb3img.s3.ap-south-1.amazonaws.com/img/python-white.svg">
                                                                Data Analytics
                                                                <!-- <div class="newTag position-absolute" >
                                                                    <img src="assets/img/newtag.gif" alt="">
                                                                </div> -->
                                                            </a></li>
                                                        <!-- botcamps sam-->
                                                        ...
                                                        <!-- <li><a href="#tabMM12" class="lstmmtab"><img
                                                                ...
                                                                Fullstack using Spring Boot + React
                                                                &nbsp;
                                                            </a></li> -->
                                                        ...
                                                        <li><a href="/live-courses.html" class="lstmmtab mmtabblue notInclude"><img
                        ...
                        Traning</a></li> -->
                                                ...
                                                <div class="col-lg-8 right">
                                                    ...
                                                    <div id="tabMM3" class="mmtab">
                                                        ...
                                                        <p class="txtwhite">These courses are designed specially
                                                            ...
                                                            students who are actively initiating Preparation for
                                                        ...
                                                        <div class="coursemenucontainer">
                                                            <div class="coursesmcontaner">
                                                                <div class="mmsmbox"
                                                                    onclick="window.location.href='interview-preparation-using-c-plus-plus.html';">
                                                                ...
                                                                <div class="mmsmbox"
                                                                    onclick="window.location.href='interview-preparation-using-java.html';">
                                                                    <img src="https://cb3img.s3.ap-south-1.amazonaws.com/img/iconCIP.webp"
                                                                        alt="">
                                                                    <div class="smboxdetail">
                                                                ...
                                                                <div class="mmsmbox"
                                                                    onclick="window.location.href='interview-preparation-non-coding-dmbs-os-networking.html';">
                                                                    <img src="https://cb3img.s3.ap-south-1.amazonaws.com/img/iconCIP.webp"
                                                                        alt="">
                                                                    <div class="smboxdetail">
                                                                ...
                                                                <div class="mmsmbox"
                                                                    onclick="window.location.href='interview-preparation-for-faang.html';">
                                                                    <img src="https://cb3img.s3.ap-south-1.amazonaws.com/img/iconCIP.webp"
                                                                        alt="">
                                                                    <div class="smboxdetail">
                                                                        Master Preparation for FAANG
                                                                        <div class="livepan"><img
                                                                                src="https://cb3img.s3.ap-south-1.amazonaws.com/img/Online.svg"
                                                                                height="20px" alt=""></div>
                                                                    </div>
                                                    ...
                                                    <div id="tabMM7" class="mmtab">
                                                        ...
                                                        <h3 class="tabhead"><img class="headicon"
                                                                src="https://cb3img.s3.ap-south-1.amazonaws.com/img/python-white.svg"
                                                                alt=""> Data Analytics with AI Tools </h3>
                                                        <p class="txtwhite">Unlock a high-paying career in Data Analytics with our comprehensive program designed for learners at all levels.</p>
                                                        <div class="coursemenucontainer">
                                                            <div class="coursesmcontaner">
                                                                <div class="mmsmbox"
                                                                    onclick="window.location.href='data-analytics.html'">
                                                                    <img src="https://cb3img.s3.ap-south-1.amazonaws.com/img/python-white.svg"
                                                                        alt="">
                                                                    <div class="smboxdetail">
                          ...
                          <div class="smboxdetail">
                            ...
                            <div class="livepan"><img src="https://cb3img.s3.ap-south-1.amazonaws.com/img/batchlive.webp" height="20px" alt=""></div>
                                                                ...
                                                                <!-- <div class="mmsmbox"
                                                                    onclick="window.location.href='summer-bootcamp.html';">
                                                    ...
                                                    <div id="tabMM10" class="mmtab">
                                                        ...
                                                        <h3 class="tabhead"><img class="headicon"
                                                                src="https://cb3img.s3.ap-south-1.amazonaws.com/img/tabindtraining.svg"
                                                                alt="">
                                                                CAST - Scholarship Test
                                                        </h3>
                                                        <p class="txtwhite">Take the Coding Blocks Scholarship Test (CAST) and get up to 100% fee waiver on premium coding
                                                            courses. Win a Wildcraft bag, T-shirt, and exclusive goodies while boosting your skills in DSA, Web Development, and
                                                            Competitive Programming. Don't miss this opportunity to learn from industry experts and kickstart your tech career!
                                                        </p>
                                                        <div class="coursemenucontainer">
                                                            <div class="coursesmcontaner">
                                                                <div class="mmsmbox"
                                                    ...
                                                    <!-- <div id="tabMM12" class="mmtab">
                                                        ...
                                                        <h3 class="tabhead"><img class="headicon"
                                                                src="https://images.codingblocks.com/misc/software.png"
                                                                alt="">
                                                            Fullstack using Spring Boot + React</h3>
                                                        <p class="txtwhite">JavaScript is essential for product-based
                                                            companies seeking to develop modern, feature-rich, and
                                                            scalable web applications that meet the demands of today's
                                                            users and markets.</p>
                                                        <p class="txtwhite">Learning the springboot can be beneficial
                                                            for web developers because it is a highly popular and widely
                                                            used technology stack in industry that is used for building
                                                            web applications.</p>
                                                        <div class="coursemenucontainer">
                                                            ...
                                                            <div class="coursesmcontaner">
                                                                ...
                                                                <div class="mmsmbox"
                                                                    onclick="window.location.href='fullstack-using-springboot-and-react.html';">
                                                                    <img src="https://images.codingblocks.com/misc/software.png"
                                                                        alt="">
                                                                    <div class="smboxdetail">
                                                                        Spring Boot + React
                                                                        <div class="livepan"><img src="" height="20px"
                                                                                alt=""></div>
                                                                    </div>
                                                                </div>
...
<!-- 
                                ...
                                <img class="megamenubtm"
                                    src="https://cb3img.s3.ap-south-1.amazonaws.com/img/megamenubtmbg.svg" alt="">
                            </div>
                        </div>

                </li>
                <li><a href="/classroom-programs.html">Classroom
                        Courses</a></li>
                <li><a href="/live-courses.html">Live
                        Courses</a></li>
                <li>
                    <a href="/sampoorna.html">Sampoorna</a>
                    <div style="width: 75%; position: absolute; top:-10px; right :-18px" >
                        <img src="./assets/img/recommended-vector.png" style="width : 100%" alt="">
                    </div>
                </li>
                ...
                <!-- <li class="d-flex" >
                    ...
                    <img src="https://upload.wikimedia.org/wikipedia/commons/4/41/Red_circle.gif" style="width : 18px; height: 18px; margin-right: 5px" alt="">
                    <a href="/google-step-internship.html">Google STEP Intern</a>
                </li>                 -->
                               
                <!-- <li class="drop-down dropdown"><a href="javascript:;" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">Events and Resources</a>
                ...
                <li>
                    <a href="/successstories.html">Success Stories
                    </a>
                </li>
                <li>
                    <a href="/data-analytics.html">Data Analytics
                    </a>
                </li>
                <!-- <li>
                    <a href="./placement-bootcamp.html">Placement Bootcamp
                        <span id="subtext-working-professionals">Working Professionals</span>
                    </a>
                </li> -->

            <!-- <li class="d-flex" >
                <img src="assets/img/flash.gif" alt="">
                <a href="/ubersheplusplus.html" class="d-flex align-items-center" >
                    <img src="assets/img/navbar-uber-logo.webp" style="margin-right: 5px;" alt="">
                    <span>SHE++</span>
                </a>
            </li>  -->

                <li style="padding-top: 5px; padding: bottom 0;" class="loginbtnnav"><a href="https://www.codingblocks.com/login.html"
    ...
    <nav class="nav-menu">
        <ul>
            ...
            <li><a href="https://hack.codingblocks.com">
                    ...
                    <span>Practice</span></a></li>
            <li><a href="https://hire.codingblocks.com">
                    <img class="mbtpicon" src="https://cb3img.s3.ap-south-1.amazonaws.com/img/iconHire.webp" alt="Hire">
                    <span>Get Hired</span></a></li>
            <li><a href="https://ide.codingblocks.com">
                    <img class="mbtpicon" src="https://cb3img.s3.ap-south-1.amazonaws.com/img/iconIDE.webp" alt="IDE">
                    <span>IDE</span></a></li>
        </ul>
    </nav><!-- .nav-menu -->
    <nav class="nav-menu">
                        ...
                        Traning</a></li> -->
                                            ...
                                            <div class="col-lg-8 right">
                                                ...
                                                <div id="mbtabMM7" class="mmtab">
                                                    <img src="https://cb3img.s3.ap-south-1.amazonaws.com/img/mmtabarrowsel.svg"
                                                        class="mmtabSel" alt="">
                                                        <h3 class="tabhead"><img class="headicon" src="https://cb3img.s3.ap-south-1.amazonaws.com/img/python-white.svg" alt="">
                                                            Data Analytics with AI Tools </h3>
                                                        <p class="txtwhite">Unlock a high-paying career in Data Analytics with our comprehensive program designed for learners
                                                            at all levels.</p>
                                                    <div class="coursemenucontainer">
                                                        <div class="coursesmcontaner">
                                                            <div class="mmsmbox"
...
<!-- 
            ...
            <li><a href="/classroom-programs.html">Classroom Courses</a>
            </li>
            <li><a href="/live-courses.html">Live
                Courses</a></li>
            <li>
                    <a href="/sampoorna.html">Sampoorna</a>
                    <div style="max-width: 127px; width: 30%; position: absolute; top: -2px; left: 85px;" >
                        <img src="./assets/img/recommended-vector.png" style="width:100%" alt="" >
                    </div>
                </li>
            <!-- <li class="d-flex" >
